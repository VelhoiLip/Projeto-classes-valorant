...
botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        ...
        classes[indice].classList.add("selecionado");
    });
});

function desselecionarClasse() {
    const classeSelecionado = document.querySelector(".classe.selecionado");
    classeSelecionado.classList.remove("selecionado");
}
